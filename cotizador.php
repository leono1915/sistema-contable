...
include 'conecta.php';
 ...
 /*if(session_status()==PHP_SESSION_NONE){
     die("<script> alert(' la sesión ha caducado'); 
     location.href='index.php';
     </script> ");
   // echo  '<h1 style="color:red;margin-top:200px;">'.$cache_limiter.' </h1>';
 }*/
					  ...
					  Espesor<input type="text" id="espesorConcepto">
					   ...
					   <input type="button" id="cerrar-popup" class="principal" value="cancelar">
										...
										<div class="botones-placas">
										  ...
										  <input  type="text"  placeholder="Nombre Cliente" value="" name="Thing" id="input"/>
										  </div>
											<div class="6u 12u$(xsmall)" id="opcionC">

...
function imprimir() {
	...
	switch(opcion){
	case true: //window.open("plantillasiniva.php?nombreCliente=" + nombreCliente + "&descuento="+ descuento +"");
	window.print();
	break;
	case false: window.open("plantilla.php?nombreCliente=" + nombreCliente + "&descuento="+ descuento +""); 
	break;
	}

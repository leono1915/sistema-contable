      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>'
         ;
          ...
          $iva+=$querys["iva"];
          $descuento=floatval($subtotal)*.08;

$datoDes;

if(number_format(floatval($total), 2, '.', '')!=number_format(floatval($totalVenta), 2, '.', '')){
 $datoDes='  <tr>
            <td colspan="2"></td>
            <td colspan="2">DESCUENTO&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp</td>
  ...
  $datoDes="";
      ...
      $plantilla.='
        ...
        <tfoot>
          ...
          <tr>
            <td colspan="2"></td>
            <td colspan="2">IVA&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp&nbsp</td>
